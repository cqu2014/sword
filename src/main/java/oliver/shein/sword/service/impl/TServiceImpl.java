...
public class TServiceImpl  implements ITService {
    ...
    public <T> T toBean(String jsonData,  Class<T> valueType) {
        T responseList = JSONArray.parseObject(jsonData,valueType);
    ...
    public static void main(String[] args) {
        ...
        String objectJson = "{\"site_from\":\"iosshom\",\"id\":\"10\",\"title\":\"宇宙上下五千年大促销\",\"operator\":\"银角大王\",\"start_time\":\"2999-12-21 13:50:48\",\"end_time\":\"2999-12-21 14:50:48\",\"language\":\"en\",\"sub_title\":\"黑色星期五年度大促销\",\"content\":\"井底点灯深烛伊，共郎长行莫围棋。玲珑骰子安红豆，入骨相思知不知\"}";
        ...
        StationNoticeDetailResponseVo noticeDetailResponseVo = tService.toBean(objectJson,StationNoticeDetailResponseVo.class);

        System.out.println(responseVoList);

        System.out.println(noticeDetailResponseVo);
    }
}
